...
namespace DSU21_5.Data
{
    public interface IArtRepository
    {
        ...
        Task<Artwork> AddArt(IImageDbContext context, IWebHostEnvironment hostEnvironment, Artwork imageModel, Member member, Exhibit exhibit); //TODO: Kolla varför interface inte klagar på att man inte implementerat alla metoder
        ...
        Task<Exhibit> CreateExhibit(IImageDbContext context, Member member);
        ...
        Task<Artwork> AddArtWithExistingExhibitId(IImageDbContext context, IWebHostEnvironment hostEnvironment, Artwork artworkModel, Member member, int? exhibit);
